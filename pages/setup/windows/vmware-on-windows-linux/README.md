...
Notice: The virtual machines provided by Microsoft must run on virtualization software such as VMware Workstation. In our guide, we recommend using [VMware Workstation Pro](https://www.vmware.com/products/workstation-pro.html), which is currently available for free.
